...
1. On the Raspberry Pi _root_ partition, alter /etc/fstab and restore the mount point for / by adding a new line at the bottom of the file. If you only have two partitions (likely), add:
